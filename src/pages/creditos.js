...
const Creditos = () => {
  return (
    <Capitulo background={`radial-gradient(63.95% 32.77% at 13.12% 8.61%, #78BEFF 0%, #326799 100%)`}>
      <MainSection>
        <div className={`bg-white bg-opacity-30 px-40 pt-40`}>
          <h3 className='text-6xl font-light text-white font-sans mb-16'>Créditos</h3>
        ...
        <div className={`shadow-xl bg-white bg-opacity-30 pt-40 pb-28 relative`}>
