  ...
  return (
    <>
      <p>
        ...
        intercambios y artefactos, se consolidó, y la línea divisoria entre la realidad y la virtualidad se volvió cada
        vez más difusa: las prácticas individuales, la comunicación, el comercio electrónico, las relaciones de
        parentesco, amistad y sociabilidad se desplegaron paulatinamente alrededor de diversos dispositivos digitales
        (Grillo, 2019, pp. 21-28).
      </p>
      ...
      <p>
        ...
        aprendizaje, la integración y la transformación. Se pensó, entonces, la tecnología como un agente de cambio, un
        medio generador de fenómenos como el hipertexto, la teoría del actor-red, los rizomas y la interconexión con
        discursos sobre biotecnología y biodiversidad (Morales, 2019, p. 35).
      </p>
      ...
      <p>
        ...
        procesos y permitían una comunicación constante con las demás personas cómo nunca se había visto. En otras
        palabras, significó entender las funcionalidades de nuevos servicios y plataformas, dispositivos que pasaron de
      ...
      <p>
        ...
        junto a la Dirección Nacional de Informática y Comunicaciones. Además, impulsaba el uso de software libre para
        el apoyo administrativo y educativo y planteaba los lineamientos en torno a los derechos de autor y
        licenciamientos de productos informáticos. Se determinó, entonces, que todo software desarrollado con el
        personal de planta o contratistas dentro de la institución sería propiedad de la universidad. Por tanto, debía
        ser registrado ante las autoridades pertinentes. Era pues un intento por consolidar una arquitectura digital
        que, para ese tiempo, ya contaba con importantes avances, aunque con poca cohesión (Acuerdo 46 de 2009).
      </p>

      <p>
        Que para estos años todas las sedes de la universidad contaran con centros de cómputo y oficinas de informática,
        ...
        estudiantes, docentes y contratistas (Acuerdo 46 de 2009).
      </p>
      ...
      <p>
        En este contexto, el Peti de 2012 puede entenderse como un referente que integró los esfuerzos y visiones sobre
        el desarrollo tecnológico de estudiantes, investigadores, profesores y administrativos. Gracias a esta
        integración, en la Universidad Nacional de Colombia, comenzó a hablarse de “cultura de la información” y su
        impacto en los procesos tecnológicos, las personas y el valor (Umaña-Acosta, comunicación personal, 28 de agosto
        de 2023). De esta forma, se crearon las bases institucionales de planes constantemente reevaluados e
        implementados.
      </p>
      ...
      <p>
        Sumado a lo anterior, las vicerrectorías de las sedes Bogotá, Manizales, Medellín y Palmira crearon una Oficina
        de Tecnologías de la Información y las Comunicaciones en cada una de sus sedes, con el deber de gestionar y
        operar la infraestructura tecnológica e implementar los sistemas de seguridad y contingencia de los recursos
        informáticos y de comunicación (Acuerdo 316 de 2019; Acuerdo 164 de 2014). Finalmente, apoyando el enfoque
        público de estas políticas, se encuentra Unimedios, organismo encargado de la difusión de información,
        promoviendo el debate público y velando por la imagen de la universidad (Acuerdo 113 de 2013).
      </p>
      ...
      <p>
        El aumento en el uso de las tecnologías de la información, la masificación del uso de computadoras, la expansión
        de internet y la gigantesca acumulación de datos por parte de gobiernos y empresas han generado la necesidad de
        desarrollar nuevos campos en el derecho y la reglamentación jurídica. El derecho informático es entendido como
        “el conjunto de normas jurídicas que regulan los efectos jurídicos nacidos de la interacción de sujetos en el
        ámbito de la informática y sus derivaciones” (Tato, 2013).
      </p>
      ...
      <p>
        ...
        “tecnología vital” implicaba también la existencia de múltiples riesgos relacionados con la posesión y manejo de
        información confidencial. Por lo tanto, se hizo necesario el desarrollo de una Política de Seguridad Informática
        y de la Información, que apoyara los esfuerzos de control y gestión tecnológica, apuntando a modelos
        sostenibles, progresivos y adaptables a los cambios tecnológicos adscritos a la normatividad y la legislación
        (Acuerdo 228 de 2016).
      </p>
      ...
      <p>
        ...
        riesgos inherentes que deben ser mitigados”. Los delitos informáticos que no pudieran ser detectados, detenidos
        y minimizados significaban un deterioro de la confianza y la fe institucional y, en consecuencia, del desarrollo
        académico, administrativo y misional de la universidad. En este orden de ideas, el objetivo fue establecer un
        primer marco clave que atravesara los procesos y los servicios informáticos, por medio de la adopción de
        medidastécnicas, estructuraslegales, recursos humanos y capacidades(Acuerdo 228 de 2016).
      </p>

      <p>
        La política de seguridad informática era también una apuesta cultural, un canal de comunicación entre todos los
        miembros de la comunidad universitaria que, además de gozar de nuevos recursos para vivir la universidad (ahora
        con una dimensión digital), también adquirieron nuevas responsabilidades derivadas de la manipulación de estos
        recursos. En ese momento eran propiamente usuarios activos de información confidencial, infraestructura
        tecnológica y servicios informáticos institucionales. Por ello, las políticas se incorporaron al Sistema
        Integrado de Gestión Académica, Administrativa y Ambiental (Siga), con miras a que toda la comunidad
        universitaria fuera responsable y mantuviera habilitados y en correcto funcionamiento los controles de
        protección contra pérdida, daño intencionado (o no) y modificación de información y procesamientos (Acuerdo 228
        de 2016).
      </p>
      ...
      <p>
        ...
        convertían en derecho (como fuente formal de lo jurídico), el derecho ejercía presión para crear costumbres. En
        otras palabras, los actos repetitivos y aceptados por una comunidad se convirtieron, paulatinamente, en
        obligatorios. A medida que estas se cristalizaban institucionalmente, se transformaban en normas (como el cúmulo
      ...
      <p>
        ...
        carencias en apropiación tecnológica, principalmente a causa de la resistencia a los cambios tecnológicos de los
        funcionarios, y la continua falta de recursos para la ejecución de proyectos. En este sentido, uno de estos
        proyectos buscó construir un modelo para generar una cultura alrededor de las tecnologías de la información,
        incluyendo mecanismos de comunicación y planes de entrenamiento continuo en tecnologías como aplicaciones
        empresariales, herramientas de ofimática, herramientas colaborativas y el uso de Internet.
      </p>
      ...
      <p>
        ...
        tecnologías digitales en la universidad. Pese a que no solucionaron todos los problemas estructurales, alrededor
        del desarrollo del plan hubo hitos importantes en temas de transformación digital, los cuales se describen a
        continuación.
      </p>
      ...
      <p>
        ...
        presupuestal (Resolución 185 de 2017).
      </p>
      ...
      <p>
        ...
        investigación e innovación social y tecnológica demostró la asombrosa capacidad de la comunidad universitaria de
        reinventarse. La transformación digital implicó, a su vez, reinventarse, en sus estructuras internas y en las
        personas que las integraban. En consecuencia, la transformación digital ha sido también una transformación
        ...
        Estas personas deben convertirse en agentes de cambio, con conciencia ética y social, capaces de contribuir a la
        construcción nacional desde el respeto a la diferencia, la inclusión social y el reconocimiento de la riqueza y
        la diversidad de las regiones (Dirección Nacional de Planeación y Estadística, 2019).
      </p>

      <h3>Estrategia de Transformación Digital 2019-2021: fundación de la Dirección Nacional de Estrategia Digital</h3>
      ...
      <p>
        La restructuración de 2019 dio un espacio privilegiado a las responsabilidades públicas de la universidad, donde
        el fortalecimiento instruccional necesariamente requería de las competencias técnicas, experienciales y
        logísticas, en materia de tecnologías de la información y las comunicaciones. En este sentido, la universidad
        debía implementar planes, estrategias y políticas que le permitieran cumplir sus funciones y acreditarse en sus
        distintos niveles.
      </p>
      ...
      <p>
        ...
        tendencias, tanto técnicas como pedagógicas y de estrategia digital. Su accionar busca cumplir los objetivos
        misionales de la universidad en cuanto al impacto en el desarrollo territorial y el bienestar de las comunidades
        del país.
      </p>
      ...
      <p>
        Actualmente, UNALab cuenta con iniciativas y proyectos prometedores que fomentan y fortalecen la cultura digital
        en la universidad, principalmente centrados en un modelo inter-sedes, en diálogo con las tendencias tecnológicas
        y las iniciativas de la Cuarta Revolución Industrial. Entre estas iniciativas, se encuentran los talleres de
        cultura digital para toda la comunidad universitaria; la medición de madurez digital para visibilizar el
        desarrollo de las diferentes sedes y facultades; la creación de Aulas STEAM en las sedes Medellín, Bogotá y
        Tumaco, con la misión de replicar el modelo del Aula STEM – Laboratorio de Fabricación (FabLab) de la Sede
        Manizales; el diseño de estrategias para visibilizar y cerrar las brechas de género; y el desarrollo de
        aplicaciones y entornos virtuales de aprendizaje inmersivo, para fortalecer la comunicación, el trabajo y el
        bienestar de la comunidad Unal—recurso 7 (UNALab, 2023)1.
      </p>
      ...
      <p>
        Desde cierto ángulo, esta división se ha erigido como líder en la implementación de políticas tecnológicas en la
        universidad. Por un lado, se encarga de presentar la propuesta presupuestal de funcionamiento e inversión para
        la gestión tecnológica, considerando las necesidades tecnológicas de las sedes de la universidad. Además,
      ...
      <p>
        ...
        de educación virtual, la universidad ya había reflexionado profundamente sobre el impacto y los alcances de las
        tecnologías digitales en la sociedad. En 2019, se contemplaba la transición hacia una “cultura de la
      ...
      <p>
        ...
        digitales, con el objetivo de generar nuevos procesos formativos, lograr vías de comunicación contemporáneas y,
        en último término, posibilitar la existencia de una universidad abierta, innovadora y en red conectada con el
        mundo (Dirección Nacional de Planeación y Estadística, 2019, pp. 141-142).
      </p>
      ...
      <p>
        A pesar de que las tecnologías digitales operan en un plano virtual que, incluso en la actualidad, es difícil de
        comprender, siempre hay personas involucradas, tanto para que tales tecnologías funcionen, como para hacer uso
        de ellas. Por esto, la transformación digital en la Universidad Nacional de Colombia ha sido posible gracias a
        la participación y la agencia activa de personas, muchas de ellas aún vinculadas a la comunidad universitaria:
        docentes, estudiantes, investigadores, personal administrativo y contratistas, etc. En este libro, hemos tenido
        la oportunidad de destacar algunas de esas voces y comprender las diferentes visiones sobre la tecnología y su
      ...
      <blockquote>
        ...
        innovaciones pedagógicas y de investigación, además de cambios fundamentales en la forma como la universidad se
        relaciona con los territorios de su país y con el mundo. La transformación digital nos permite consolidar formas
        de organización más descentralizadas, flexibles y livianas, tomar decisiones horizontales y democráticas, y
        acceder a modos de trabajo por procesos más eficientes y efectivos. (Universidad Nacional de Colombia, 2022a, p.
        15)
      </blockquote>

      <p>
        La universidad se piensa en un contexto más amplio, no solo en su desarrollo académico, sino también en su
        interconexión con los demás seres humanos y los otros seres que habitan el planeta. En ese sentido, se adquieren
        responsabilidades éticas, identitarias y prácticas para afrontar las múltiples crisis que enfrenta el planeta,
        en términos económicos, ecológicos, educativos, democráticos y de salud. Así las cosas, el uso de las
        tecnologías digitales se vuelve transversal a la solución de estos problemas —figura 17 (Universidad Nacional de
        Colombia, 2022a).
      </p>
      ...
      <p>
        ...
        medio de la naciente crisis. Además de los problemas en materia económica y de salud pública, la pandemia afectó
        el núcleo emocional de las sociedades y aceleró la necesidad de repensar y construir nuevas respuestas
        ...
        relación entre la presencialidad y la virtualidad. Sumado a ello, en los últimos años se ha tomado conciencia de
        la fragilidad del Estado en proveer servicios fundamentales como la salud y la educación (Universidad Nacional
        de Colombia, 2022a, pp. 20-120).
      </p>
      ...
      <p>
        Por otro lado, la pandemia puso de manifiesto las enormes brechas tecnológicas de los estudiantes, profesores y
        personal administrativo en el uso y acceso de las tecnologías, una muestra de las falencias de la universidad
        durante la crisis. Por ejemplo, con el paso de los meses, se demostró la necesidad vital de acceder a un buen
        servicio de internet y una infraestructura académica óptima, elemento desigual entre las distintas comunidades
        académicas de las sedes. La pandemia obligó a la universidad a dar un gran salto hacia la educación en ambientes
        virtuales e híbridos, al tiempo que evidenció las disparidades entre territorios, sedes y personas,
        materializadas en la preocupante deserción, problemas de aprendizaje, exclusión y dificultades socioeconómicas,
        entre otras —recurso 8 (Universidad Nacional de Colombia, 2022a, p. 22).
      </p>
      ...
      <p>
        ...
        sostenibilidad (económica, educativa, social y cultura) de la comunidad universitaria, con calidad durante todo
        el proceso educativo. En definitiva, la pandemia relució el compromiso de la universidad en generar espacios de
        pertenecía y cohesión social que diluyan las brechas sociales, apostando por acciones éticas, equitativas y
        democráticas que impulsen la inclusión, la equidad de género, el reconocimiento de la diversidad, la integración
        cultural y el bienestar colectivo. Fruto de esta reflexión, la conectividad y la educación se reconocen hoy como
        elementos inseparables, como bien público social y como un derecho humano y universal y, por tanto, un deber del
        Estado (Universidad Nacional de Colombia, 2022a, p. 22).
      </p>

      <p>
        Finalmente, la universidad ha venido asimilando los aprendizajes de la pandemia en la exploración de sus
        posibilidades en el mundo virtual. Asimismo, ha destacado el carácter fundamental de la presencialidad y el uso
        de los espacios físicos para la formación integral de las personas.
      </p>
      ...
      <ul>
        ...
        <li>
          — La Cátedra Nacional de Transformación Digital. Una asignatura ofertada en las nueve sedes, para estudiantes
          de pregrado. Es un espacio académico propicio de revisión, reflexión y análisis de múltiples entornos de la
          transformación digital, para conocer las estrategias y experiencias de los sectores público y privado en el
          país y el mundo.
        </li>
        <li>
        ...
        <li>
          — Despliegue del “Tablero de comando de madurez digital”, un proyecto de la División Universidad Laboratorio,
          para visibilizar el desarrollo de las diferentes sedes y facultades, en el cumplimiento de los procesos de
          transformación digital inter-sedes, así como evidenciar algunas experiencias y prácticas exitosas de la
      ...
      <p>
        ...
        derechos y deberes y el uso de las tecnologías emergentes.
      </p>
      ...
      <p>
        ...
        trata de un esfuerzo por crear una red de transformación digital entre las personas, y los distintostipos de
        hardware y software —recurso 10 (García-Camargo, 2023).
      </p>
      ...
      <p>
        ...
        tecnologías digitales: las interfaces gráficas. Mónica Forero Díaz estudió diseño en la Unal, a comienzos de la
        década 1990 y, a partir de 1995, comenzó a trabajar con tecnologías digitales en la creación de interfaces
        gráficas, convirtiéndose en docente de la Escuela de Diseño Gráfico desde 2010. El reto de Mónica era enorme:
        traducir un lenguaje computacional a un lenguaje gráfico que las personas pudieran utilizar. Aunque las máquinas
        existían, la gente no podía usarlas como las empresas buscaban en su momento.
      </p>
      ...
      <p>
        ...
        tradicional del diseño no lo consideraba necesario. Por fortuna, las iniciativas como los laboratorios digitales
        facilitaron el encuentro entre saberes, perspectivas y necesidades (Forero-Díaz, comunicación personal, 29 de
        agosto de 2023).
      </p>
      ...
      <p>
        ...
        coaccionar el comportamiento y las decisiones de las personas (Forero-Díaz, comunicación personal, 29 de agosto
        de 2023).
      </p>
      ...
      <p>
        ...
        acceder a Internet y equipos (Camacho-Navarro, comunicación personal, 16 de agosto de 2023). Vale resaltar que
        parte de estas fortalezas se deben a que es una de las sedes más recientes de la universidad (su funcionamiento
        inició en 2019) y, por tanto, cuenta con una de las mejores infraestructuras físicas y tecnológicas.
      </p>

      <p>
        No obstante, aún persisten brechas significativas en cuanto las potencialidades de la universidad en la Sede de
        La paz. La primera esla existencia de procesos manualesinnecesarios y burocráticos, que retrasan procesos
      ...
      <p>
        ...
        analizado las necesidades cambiantes en una universidad que ya no es netamente física, sino también virtual. La
        virtualidad permite la presencia de cualquier persona del mundo en los espacios universitarios, una suerte de
        aula expandida que también amplía sus conexiones. Sin embargo, para que esto ocurra, deben implementarse
        procesos de pedagogía y capacitación digital, ligados a los procesos de investigación y formación. A diferencia
        de la Sede de La Paz, Medellín tiene fuertes limitaciones por la obsolescencia tecnológica y problemas de
        conectividad (Restrepo-Gutiérrez, comunicación personal, 11 de agosto de 2023).
      </p>

      <p>
        A pesar de ello, la Sede Medellín ha insistido en la necesidad de vincular la estructura física con la digital
        para optimizar el uso de los recursos. Un ejemplo de ello fue que, durante la pandemia, el consumo de agua de la
        Sede Bogotá no bajó, a pesar de que las instalaciones no se usaban, lo que demostró que hay inmensas pérdidas en
        las redes de agua. Este caso evidencia que en la mayoría de las sedes no existe un monitoreo ágil y oportuno del
        estado físico de su infraestructura. Afortunadamente, la Sede Medellín ha tomado la iniciativa en este campo, al
        usar un sistema de información para la administración y gestión de espacios, donde se ha generado una red de
        monitoreo de los edificios, para identificar los problemas en el mantenimiento. De modo que, también hace falta
        implementar estossistemas de administración de espacios en el ámbito académico, como la distribución de salones
        o la inscripción de asignaturas de forma más equitativa (Restrepo-Gutiérrez, comunicación personal, 11 de agosto
        de 2023).
      </p>
      ...
      <p>
        ...
        mismas posibilidades, recursos y capacidades para afrontar los retos de la transformación digital. El caso de la
        Sede Orinoquía es ilustrativo. Javier Carreño Ortiz, coordinador de la infraestructura digital de esta sede,
        destaca la importancia de la articulación de las sedes de presencia nacional con las demás, principalmente
        porque estas no son autónomas en la disposición de recursos. Como se ha evidenciado, las principales
        dependencias se alojan en Bogotá, Palmira, Manizales y Medellín. En ese sentido, en la Sede Orinoquia no es
        posible hablar estrictamente de estratégicas de transformación digital, al menos no en los términos en los que
        se ha experimentado en otras sedes. Ello se debe, principalmente, a los desafíos en conectividad y la falta de
        recursos para ejecutar proyectos que se proponen desde los territorios (Carreño-Ortiz, comunicación personal, 4
        de agosto de 2023).
      </p>

      <p>
        Desde la oficina de infraestructura digital de la Sede Orinoquía, no se han ejecutado proyectos propios, más
        allá de brindar apoyo a iniciativas docentes o investigativas. Sin embargo, esto no ha impedido que se propongan
      ...
      <p>
        Estas iniciativas tienen el propósito de convertirse en un medio tanto académico como de difusión, para conocer
        las dinámicas de biodiversidad del territorio y consolidarse como estrategias de apropiación de tecnologías
        digitales. Sin embargo, hasta el momento, no han contado con los recursos para su ejecución. Como es evidente,
        estas propuestas se relacionan profundamente con las fortalezas académicas y culturales de las sedes de
        presencia nacional, y se proyectan dentro de los lineamientos institucionales de la Estrategia de Transformación
        Digital. En este caso, los componentes que se han requerido son la dotación de equipos y materiales, la
        ampliación de cobertura wifi, la construcción de materiales didáctico en realidad aumentada y realidad virtual,
        el desarrollo de una interfaz gráfica y la implementación de acciones de formación y divulgación de conocimiento
      ...
      <p>
        ...
        equitativas y democráticas, que impulsen la inclusión, la equidad de género, el reconocimiento de la diversidad,
        la integración cultural y el bienestar colectivo (figuras 24-25).
      </p>
