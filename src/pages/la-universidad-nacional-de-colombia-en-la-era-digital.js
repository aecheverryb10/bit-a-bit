export default function UniversidadEraDigital() {
  return (
    <>
      <p>
        Las computadoras están compuestas por circuitos eléctricos que desempeñan una función fundamental: llevar a cabo
        operaciones lógicas. A diferencia de los circuitos que tradicionalmente se encontraban en los dispositivos
        electrónicos y que se utilizaban para encender-apagar, regular el flujo eléctrico, convertir la energía
        eléctrica en otras formas de energía y ampliar señales, entre otras funciones, las computadoras empezaron a
        emplear un tipo de circuito capaz de realizar operaciones matemáticas simples: las puertas lógicas (figura 1).
      </p>
      ...
      <p>
        ...
        67-71). Sin embargo, nuestra institución estuvo atenta al desarrollo tecnológico global y sus implicaciones en
        la educación y el funcionamiento de las organizaciones.
      </p>
      ...
      <p>
        ...
        impulsos eléctricos; la cámara recorría la muestra y enviaba impulsos cada vez que un rayo chocaba con la imagen
        de las células sanguíneas. Su potencial era enorme, pues permitía hacer recuentos de corpus sanguíneos de forma
        exacta y automática, lo que evidenciaba que el desarrollo de estas tecnologías tenía fuertes potencialidades en
        la medicina (Facultad de Medicina, 1954, pp. 369-371).
      </p>

      <p>
        Para la comunidad universitaria, el paso de lo manual a lo automático, de lo análogo a lo digital, de lo
        mecánico a lo electrónico significó la disminución de los tiempos para realizar tareas (figura 2). En principio,
        el desarrollo de las tecnologías digitales encarnó eso, la aceleración de los procesos. Diego López, miembro de
        la Facultad de Ingeniería, analizó las implicaciones de este tránsito en la década de 1960. Reflexionó sobre las
        diferencias entre un computador análogo y uno digital: por un lado, el computador análogo es un sistema físico
        (electrónico y mecánico) en el que se resuelven ecuaciones matemáticas de forma similar a las relaciones de
        variables de problemas específicos —es decir, la operación física que realiza la máquina es similar al problema
        que tiene que resolver. Este tipo de computador es más parecido al ábaco o el sanguinómetro mencionado—. Por
        otro lado, el computador digital es un sistema capaz de almacenar información aritmética, realizar operaciones y
        tomar decisiones lógicas a gran velocidad. El primero, maneja los datos de forma continua y el segundo, a través
        de un sistema numérico binario, como se ha dicho (López, 1965, p. 46).
      </p>

      <h1 className='text-9xl'>FOTO</h1>

      <p>
        Más allá de los tecnicismos, la opción por uno u otro tenía implicaciones significativas para su uso práctico en
        el ámbito educativo. Las computadoras digitales podían realizar cálculos más veloces y precisos, por su
        capacidad de realizar operaciones algebraicas y almacenar información. Sin embargo, eran equipos más costosos en
      ...
      <p>
        No era extraño que una empresa de tal trayectoria propiciara el desarrollo de esta ciencia en las universidades.
        El Acuerdo 1 de 1954 evidenciaba que la universidad estaba conectada a un esfuerzo mayor por desarrollar estas
        tecnologías. El encargado de diseñar el programa del curso fue el ingeniero David W. Mehl, graduado de la
        Escuela de Zúrich y miembro de la Sociedad de Matemáticas de México. Dos elementos capitales guiaron los
        contenidos del curso: primero, un nutrido recorrido por los principios de la telefonía, la electrónica aplicada
        y las líneas de comunicación a larga distancia; segundo, un apartado sobre la conmutación, sus fundamentos y sus
        dispositivos (Acuerdo 1 de 1954).
      </p>
      ...
      <p>
        ...
        investigación en computación y, con ello, prestar servicios a otras entidades de carácter oficial o privado. Era
        una apuesta por la automatización que afectaba a varios estamentos de la universidad: por una parte, el
        estudiantado, pero también las profesoras y los entes administrativos. En este sentido, se pensaba en el
        aprovechamiento de las máquinas no solo con fines de investigación, sino también para optimizar procesos
      ...
      <p>
        ...
        uso de computadoras analógicas a tecnologías más avanzadas. El Laboratorio de Electrónica de la Facultad de
        Minas se muestra en las figuras 5-8.
      </p>
      ...
      <p>
        ...
        Departamento de Ingeniería de Sistemas (Castellanos-Aceros, 2001, pp. 115-116).
      </p>
      ...
      <p>
        ...
        contribuyendo así al avance de la computación electrónica, las ciencias de la informática y los modelos
        matemáticos de sistemas de información. El dominio de estas herramientas técnicas y tecnológicas buscaba aportar
        soluciones a problemas nacionales en la administración de recursos y el desarrollo social y económico
        (Castellanos-Aceros, 2001, pp. 116–117).
      </p>
      ...
      <p>
        ...
        continuación, se destacan algunos de los hitos más importantes en este proceso de transformación digital.
      </p>

      <h3>Las telecomunicaciones</h3>

      <p>
        Como se dijo, para finales de la década de 1960, se crearon varias dependencias especializadas en las ciencias
        computacionales y se estableció un curso completo sobre telecomunicaciones en 1954. Para esta segunda cara del
        proceso de adaptación a la era digital, era fundamental tener un aparato organizativo que regulara cómo la
        universidad se conectaba con el mundo. Ya desde la década de 1940 se adelantaron intentos para desarrollar este
        campo a través de una alianza entre la Empresa Nacional de Radiocomunicaciones, los Bancos y la Facultad de
        Ingeniería en Bogotá (Acuerdo 10 de 1947).
      </p>

      <p>
        Para 1965, existían dos dependencias que regulaban ese contacto mundo-universidad: el sistema de correos y la
        oficina de portes y telecomunicaciones, todos a cargo de la Dirección de Servicios Generales (Acuerdo 205 de
        1965). Como es evidente, fue necesario el constante apoyo de entidades privadas y públicas, para que las
        telecomunicaciones no solo fueran una dependencia administrativa de la universidad, sino también un campo del
        conocimiento en desarrollo, que permitiera interactuar con el sector académico y productivo. Como ejemplo de lo
        anterior, en 1985, en el marco del Programa de Investigación y Divulgación Científica y Tecnológica, se
        establecieron contratos de investigación con el Departamento del Tolima, la Empresa Colombiana de
        Telecomunicaciones (Telecom), la Empresa de Energía Eléctrica de Bogotá y el Departamento de Planeación (Acuerdo
        95 de 1985).
      </p>

      <p>
        La colaboración con estas entidades facilitó el desarrollo de investigaciones y cursos dentro de las carreras
        existentes, así como la creación de nuevos programas académicos con enfoques especializados. Se reconocía
        ampliamente que las denominadas "nuevas tecnologías de la información" tenían impacto en todas las actividades
        humanas. Por tanto, los programas curriculares debían abordar problemas a través de un enfoque sistemático en la
        aplicación de estas tecnologías. Un ejemplo de esto fue la creación de la carrera de Ingeniería Electrónica en
        1991, en la Facultad de Ingeniería y Arquitectura de la Sede Manizales. Este programa buscaba explorar las
        principales áreas de innovación de la época, como la microelectrónica, las telecomunicaciones y la informática,
        a través de la investigación y el diseño (Acuerdo 34 de 1991).
      </p>
      ...
      <p>
        ...
        estaban estrictamente integradas a proyectos o dependencias de la universidad; a primera vista, cada una iba por
        su cuenta. Desde la década de 1960 este proceso fue paulatino, e inició con los centros de computación y cálculo
        en Bogotá y Medellín. En 1966, se habló de la organización de la División de Docencia e Investigación,
        estableciendo una primera relación entre la computación y la comunicación. En esta división se integraron el
        Centro de Computación y el Centro de Medios Audiovisuales, ambos enfocados a la docencia, la investigación y los
        sistemas de enseñanza y difusión cultural en la universidad. Una apuesta por integrar a la comunidad
        universitaria, a través de medios tecnológicos (Acuerdo 3 de 1966).
      </p>
      ...
      <p>
        ...
        además, formas de intercambio y colaboración de investigaciones, materiales y equipos con otras instituciones
        nacionales y extranjeras (Acuerdo 6 de 1973). Posteriormente, en 1982, se creó la Oficina de Sistemas de
      ...
      <p>
        ...
        computacionales. El computador se ubicaba en una sala de unos 60 metros cuadrados, donde había también equipos
        de enfriamiento de espacios para disipar el calor de una máquina de grandes dimensiones. Pocos estudiantes
        accedían directamente al computador, que era controlado por un funcionario del centro de cómputo, encargado de
        realizar las operaciones que estudiantes y profesores solicitaban. No obstante, los estudiantes podían acceder a
        las máquinas perforadoras de tarjetas para escribir instrucciones en código binario que el computador leería
        posteriormente. Después de escribir el programa, las tarjetas se recopilaban y se entregaban al funcionario para
        que las introdujera, tarjeta por tarjeta, al computador (J. I. Peña Reyes, comunicación personal, 25 de agosto
        de 2023).
      </p>

      <p>
        A pesar de la aceleración de los procesos que significaba el uso de esta máquina, el paso a paso no era
        sencillo: primero, hacer filas para usar las máquinas perforadoras; después, escribir las instrucciones de lo
        que se quería computar; posteriormente, hacer otra fila para entregar las tarjetas al centro de cómputo y,
        finalmente, esperar los resultados. Estos computadores no tenían interfaces tan desarrolladas como las de las
        pantallas actuales; en su lugar, la interfaz de salida eran papeles impresos con los resultados de cada
        operación. Si las instrucciones no se escribían correctamente en la tarjeta, el resultado arrojaba un error y
        debía repetirse todo el proceso (J. I. Peña Reyes, comunicación personal, 25 de agosto de 2023).
      </p>

      <p>
        La computación avanzaba a pasos de gigante. Para inicios de la década de 1980, los estudiantes tuvieron contacto
        con las computadoras a través de las perforadoras de tarjetas; pero al finalizarla, ya tendrían acercamientos a
        computadores de escritorio: las microcomputadoras. Uno de estos equipos primero llegó a la Facultad de Ciencias
        Económicas para tratar problemas de econometría. Paulatinamente, las facultades irían adquiriendo estos
        dispositivos y organizando sus sistemas de información y bases de datos de forma autónoma a lo largo y ancho de
        la universidad. El impacto de las microcomputadoras fue enorme, pues ya no solo los ingenieros manejaban los
        sistemas de información, sino también personas de diversas disciplinas que buscaban organizar y tomar decisiones
        en torno a ella. De esa manera, cambiaron la manera en que se administraba y funcionaba la educación
        universitaria (J. I. Peña Reyes, comunicación personal, 25 de agosto de 2023).
      </p>

      <p>
        Posteriormente, en la década de 1990, la Universidad Nacional de Colombia unificó en ciertas dependencias las
        ramas de la informática y las telecomunicaciones, influenciada por la irrupción de Internet en la sociedad y los
        centros educativos (recurso 2). Con la redefinición de la estructura a nivel nacional de la universidad en 1997,
        se crearon tres organismos esenciales en la consolidación de la cultura digital en la comunidad universitaria:
        la División de Informática y Comunicaciones, la Dirección Nacional de Informática y Comunicaciones y la Unidad
        de Medios de Comunicación —Unimedios (Resolución 863 de 1997). Un año después, se creó el Comité Nacional de
      ...
      <p>
        ...
        permitiendo la definición de sistemas integrados para la ejecución de planes académicos y administrativos, la
        articulación y comunicación entre sedes, así como la formulación de proyectos para la adquisición, uso y
        desarrollo de software y hardware dentro de la universidad. Sumado a esto, Unimedios unificó en su dirección la
        oficina radial, de producción audiovisual y de comunicaciones e imágenes corporativas, de manera que se
      ...
      <p>
        ...
        M. Sánchez Torres, comunicación personal, 29 de junio de 2023).
      </p>

      <p>
        Bitnet fue una red informática norteamericana de telecomunicaciones que enlazó más de mil organizaciones a nivel
        internacional con fines educativos y de investigación. Cada organización creaba nodos a través de computadores,
      ...
      <p>
        La Universidad Nacional de Colombia fue uno de los nodos de dicha red, controlado en la Unidad de Servicios de
        Computación, donde un operador tenía el deber de mantener comunicación permanente con ambas redes (Acuerdo 12 de
        1992). Los impactos de esta conexión entre comunidades académicas fueron muy significativos. Efectivamente,
        permitió un primer contacto antes del establecimiento de internet, cambiando incluso las condiciones materiales
        de cómo se relacionaban las personas, el ejemplo más evidente de este cambio el correo electrónico (J. M.
        Sánchez-Torres, comunicación personal, 29 de junio de 2023).
      </p>

      <p>
        Tras la experiencia con estas primeras redes, el uso de Internet se volvió cada vez más común, primero, para la
        institución y, después, para los estudiantes, convirtiéndose paulatinamente en una herramienta obligatoria para
        las labores académicas. Por esta razón, desempeñó un papel fundamental en las discusiones sobre la conectividad
        de las sedes de presencia nacional, donde los equipos y los medios materiales no permitían los mismos tipos de
        conexión que en las ciudades capitales.
      </p>
      ...
      <p>
        ...
        actividades se efectuaran, es significativo que se plantearan estas posibilidades, lo que pone en evidencia la
        rapidez con la que las ciencias informáticas y las redes estaban avanzando (figuras 9-10).
      </p>
      ...
      <p>
        ...
        permitieran suplir necesidades organizativas propias de una institución de grandes dimensiones. Un ejemplo de
        ello fue el aporte de la ingeniera Liliana Piñeros, estudiante en 1988-1995 (Piñeros-Fernández, 2023).
      </p>

      <p>
        Ella se graduó con un sistema de información financiera, que se usó en la universidad durante más de siete años,
        gracias también a las iniciativas de profesores que intercedieron por la recuperación y el uso de estos
        programas, otros softwares para el manejo de bienes e inventarios, así como la administración del personal
        universitario, los cuales fueron desarrollados por funcionarios y estudiantes. Los aportes de la Facultad de
        Ingeniería en materia de innovación y adaptación de software a las necesidades particulares de la universidad
        fueron invaluables antes de finalizar el segundo milenio (J. I. Peña Reyes, comunicación personal, 25 de agosto
        de 2023).
      </p>
      ...
      <p>
        ...
        comenzó a usarse ampliamente en los años 1980 en varias redes de bibliotecas y archivos a nivel global, por lo
        que es un software poco usual, por su larga vida en el campo de las aplicaciones informáticas. Su uso como
        recurso electrónico ha permitido una revolución en las bibliotecas especializadas, por su amplia capacidad para
        la gestión de datos que tratan recursos con soportes físicos (“Sistema Aleph 500”, 2008; Olmedo Granados, 2017).
      </p>
      ...
      <p>
        ...
        convirtiéndose en el sistema que se usa hasta la actualidad para la gestión de bibliotecas. El sistema Aleph se
        implementó en todas las sedes y, posteriormente, se unificó en una única base de datos —figuras 11-12 (J. A.
        Sánchez Peña, comunicación personal, 14 de junio de 2023).
      </p>

      <h1 className='text-9xl'>DOBLE FOTO</h1>

      <p>
        De esta forma, comenzaron a usarse softwares preexistentes y sistemas propios, para la administración interna de
        la universidad. Es un hecho que, además de la estructura física que soportaba el funcionamiento de la
        institución –donde los estudiantes y profesores impartían clase, los espacios de sociabilidad, deporte y
        actividad política–, también se erigieron importantes edificios que soportaban esa otra cara que empezaba a ser
        comprendida por la comunidad, la dimensión virtual. Esta permite acciones como la admisión de estudiantes, la
        inscripción de asignaturas, el pago de empleados, el manejo de inventarios y la sistematización de proyectos
        académicos.
      </p>

      <p>
        Uno de los primeros softwares desarrollados autónomamente por la Universidad Nacional fue Hermes, un sistema
        nacido en 2005 como una herramienta para la recopilación de información sobre las actividades investigativas de
        los diferentes agentes de la universidad: profesores, estudiantes y funcionarios (Innovación Unal, 2014).
        Gracias a la sistematización y el registro de esta información, desde 2007, pudo construirse conocimiento más
        preciso sobre el campo de investigación y, por consiguiente, para el manejo y toma de decisiones en este ámbito.
        Para 2014, Hermes se convirtió en la única herramienta informática que reunía los datos relacionados a
        investigación y extensión, lo que permitió la unificación, regulación y seguimiento de todos los proyectos de
        este tipo dentro de la universidad (Resolución 9 de 2014). Los efectos de la unificación de estas bases de
        información en un solo sistema fueron variados: desde el mejor manejo de presupuestos y su apropiada
        distribución, pasando por el mejoramiento de las interfaces gráficos para el registro de los proyectos, hasta la
        comprensión más precisa de las dimensiones de producción investigativa.
      </p>
      ...
      <p>
        ...
        presupuestales que se comprendían desde otras disciplinas. En la actualidad, Quipu es concebido como un “sistema
        integrado de información que permite el registro, seguimiento y control detallado de las operaciones asociadas
        al macroproceso de gestión administrativa y financiera de la Universidad Nacional” (Almanza, 2017, p. 2).
      </p>

      <p>
        Paralelamente, en 2002, la universidad adquirió el Sistema de Información de Talento Humano Sara, como una
        herramienta para la gestión y planeación del talento humano, la selección y vinculación de personal, el registro
        de trayectorias y, en determinados casos, la desvinculación. Su funcionamiento inició en las sedes de Bogotá,
        Medellín, Palmira y Manizales a lo largo de 2002, experimentando en los años siguientes un paulatino proceso de
        enriquecimiento de sus funciones. En sus inicios fue adquirido como un software comercial con arquitectura
        cliente- servidor, con módulos de nómina y puntajes. Posteriormente, en 2007, se comienza a usar para la
        administración de nóminas pensionales, alcanzando a incluir a cerca de cuatro mil personas.
      </p>

      <p>
        Entre 2009 y 2015, se incluyeron módulos para registrar hojas de vida, salud ocupacional y puntaje web; y a
        partir de 2016, comenzó un proceso de unificación de sus bases de datos. El uso de Sara ayudó a solucionar el
        gran problema de manejo de las bases de datos generadas en cada uno de los centros de cómputo de las sedes de la
        universidad que debían ocuparse de la gestión de la planta docente, administrativa, ocasional y, en algunos
        casos, de estudiantes auxiliares (Salamanca Guerrero, comunicación personal, 15 de septiembre de 2023).
      </p>
      ...
      <p>
        ...
        calificaciones, etc. (Acuña-Garzón, 2016, pp. 15- 18).
      </p>
      ...
      <p>
        ...
        por medio del uso de herramientas de la comunicación electrónica. A su vez, integró a la ciudadanía en los
        flujos de información actualizada y unificada de los programas académicos, las asignaturas y las actividades
        académicas (Universidad Nacional de Colombia, 2015).
      </p>
      ...
      <p>
        ...
        administración de programas curriculares, planta física, matrícula financiera y hojas de vida de estudiantes. De
        2005 a 2006, se actualizó el sistema y se desarrollaron los módulos de solicitudes y deudas estudiantiles. A
        partir de 2010, el sistema se adaptó a los cambios estatutarios de la universidad enfocados en los créditos
        académicos y la modificación del Estatuto Estudiantil. Por último, en 2015 se actualizó la plataforma
        tecnológica para aumentar la velocidad y el desempeño de los servicios, incluyendo la emisión de certificados de
        matrícula y calificaciones, haciendo uso, esta vez, de firmas digitales —figura 13 (Acuña- Garzón, 2016).
      </p>
      ...
      <p>
        ...
        especializados en el manejo de las máquinas, sino que, ahora, todos debían enfrentarse a un mundo desconocido
        lleno de posibilidades sin precedentes, así como a barreras culturales inevitables. La era digital había llegado
        a la universidad y todos sus miembros debían adaptarse a una nueva realidad marcada por la consolidación de un
        lenguaje común.
      </p>
    </>
  );
