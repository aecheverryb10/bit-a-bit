...
export default function Home() {
  return (
    <main className={`min-h-[100vh] bg-cover`} style={{backgroundImage: `url('./img/cubierta.png')`}}>
      <div className="w-full min-h-[100vh] flex flex-col align-center justify-center relative">{/*bg-portada */}       

        <div className="bg-black bg-opacity-70 py-4 text-center">
          <div className="container">
            <h2 className="uppercase tracking-[0.18em] text-white"><span className="border-r border-white font-medium pr-4 mr-4">Bit a bit</span> <span className="font-light">La evolución digital en la Universidad Nacional de Colombia</span></h2>
          </div>
        </div>
              ...
              <div className="flex flex-col h-full">
                ...
                <div className="grow border-y border-white grow font-light text-3xl flex justify-end">
                  <div className="">
                    ...
                    <span className="block rounded-full border border-white h-8 mx-auto w-8 flex items-center justify-center"><img src="./img/arrow-down.svg" alt="arrow down" className="w-4"/></span>
                    <h2 className="mt-7">Introducción</h2>
                  </div>
                </div>
                <div className="bg-blend-multiply text-center py-24">
                </div>
              </div>
            </div>

            <div className="z-20 relative basis-1/5 h-full shadow-capitulo" style={{background: `linear-gradient(233.61deg, rgba(74, 70, 255, 0.2) 32.21%, rgba(44, 42, 153, 0) 91.49%), url('./img/capitulo1-portada.png') center / cover`}}>
              <div className="flex flex-col h-full">
                ...
                <div className="grow border-y border-white grow font-light">
                  <span className="block border-l border-white h-16 mx-auto w-0"/>
                  <span className="bg-blue-base block rounded-full border border-white h-8 mx-auto w-8 flex items-center justify-center"><img src="./img/arrow-down.svg" alt="arrow down" className="w-4"/></span>
                  <h2 className="text-3xl mt-7">Ascendencias digitales</h2>
                  <p className="font-extralight text-2xl">perspectivas globales<br/> y el caso colombiano</p>
                </div>
                <div className="color-capitulo1 bg-blend-multiply text-center py-24">
                </div>
              </div>
            </div>

            <div className="z-10 relative basis-1/5 h-full bg-cover shadow-capitulo" style={{background: `linear-gradient(233.61deg, rgba(74, 70, 255, 0.2) 32.21%, rgba(44, 42, 153, 0) 91.49%), url('./img/capitulo2-portada.png') center / cover`}}>
              <div className="flex flex-col h-full">
                ...
                <div className="grow border-y border-white grow font-light">
                  <span className="block border-l border-white h-16 mx-auto w-0"/>
                  <span className="block bg-purple-base rounded-full border border-white h-8 mx-auto w-8 flex items-center justify-center"><img src="./img/arrow-down.svg" alt="arrow down" className="w-4"/></span>
                  <h2 className="text-3xl mt-7">La Universidad Nacional de Colombia en la era digital</h2>
                </div>
                <div className="color-capitulo2 bg-blend-multiply text-center py-24">
                </div>
              </div>
            </div>

            <div className="basis-1/5 h-full bg-cover" style={{background: `linear-gradient(233.61deg, rgba(74, 70, 255, 0.2) 32.21%, rgba(44, 42, 153, 0) 91.49%), url('./img/capitulo3-portada.png')`}}>
              <div className="flex flex-col h-full">
                ...
                <div className="grow border-y border-white grow font-light">                  
                  <span className="block border-l border-white h-16 mx-auto w-0"/>
                  <span className="bg-green-light block rounded-full border border-white h-8 mx-auto w-8 flex items-center justify-center"><img src="./img/arrow-down.svg" alt="arrow down" className="w-4"/></span>
                  <h2 className="text-3xl mt-7">Cultura digital UNAL</h2>
                  <p className="font-extralight text-2xl w-56">caminos a la<br/> transformación digital</p>
                </div>
                <div className="color-capitulo3 bg-blend-multiply text-center py-24">
                </div>
              </div>
            </div>
            ...
            <div className="basis-full h-full bg-cover">
              <div className="flex flex-col h-full">
                ...
                <div className="grow border-y border-white grow font-light">
                  ...
                  <p className="font-extralight text-2xl">La transformación digital,<br/> un proceso inacabado</p>
                </div>
                <div className="bg-blend-multiply text-center py-24">
                </div>
              </div>
