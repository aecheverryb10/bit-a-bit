...
const TimelineModal = (props) => {
  ...
  return (
    ...
    >
      <button
        className='absolute bg-white rounded-full w-[39px] h-[39px] right-[30px] text-[#02EBB6] hover:scale-105'
                ...
                {child.image && (
                  <div className='relative my-4 rounded-2xl'>
                    <Image
                      ...
                      src={child.image}
                      fill
                      className={`!relative border-8 bg-white border-white rounded-2xl mb-3 mx-auto !max-h-96 ${
            ...
            {data.image && (
              <div className='relative grow rounded-2xl'>
                <Image
                  ...
                  fill
                  objectFit='contain'
                  className={`!w-auto border-8 rounded-2xl bg-white border-white mb-3 mx-auto ${
