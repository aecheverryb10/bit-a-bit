        ...
        <div className='pl-48 pr-16 py-16 relative z-10 bg-blue-dark bg-opacity-30'>
          <div className='max-w-[700px] font-ancizar leading-none'>
            ...
            <p className='font-bold text-3xl my-4'>
              ¿Puede la Inteligencia Artificial hacer que l@s profesor@s desaparezcan?
            </p>
            <p className='text-xl'>Una conversación con el profesor Fabio Augusto González Osorio</p>
          </div>
